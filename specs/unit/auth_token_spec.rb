...
describe 'Test Auth Token' do
  ...
  it 'HAPPY: should return the correct contents' do
  ...
  it 'SAD: should raise ExpiredTokenError if the token is expired' do
  ...
  it 'BAD: should raise InvalidTokenError if the token is invalid' do
    proc {
